...
bool Qutepart::getLineError(int lineNumber) const
{
    return getBlockFlag(lineNumber, ERRROR_BIT);
}
...
bool Qutepart::getLineInfo(int lineNumber) const
{
    return getBlockFlag(lineNumber, INFO_BIT);
}
